...
public class ObjSaverTest {
    ...
    void testSaveSimpleModel() throws ModelSavingException {
        ...
        assertTrue(content.contains("v 0.000000 1.000000 0.000000"));
    ...
    void testSaveWithTextureCoords() throws ModelSavingException {
        ...
        assertTrue(content.contains("vt 0.000000 1.000000"));
    ...
    void testModelValidation() {
        // Пустая модель должна вызвать ошибку
        ...
        // Модель без полигонов должна вызвать ошибку
    ...
    void testRoundTrip() throws ModelLoadingException, ModelSavingException {
        ...
        // Проверяем, что базовая структура сохранилась
    ...
    // Вспомогательные методы для создания тестовых моделей
    ...
    private Model createModelWithTextures() {
        ...
        // Обновляем полигон с текстурными индексами
    ...
    private Model createModelWithNormals() {
        ...
        // Обновляем полигон с индексами нормалей
        Polygon polygon = model.polygons.get(0);
